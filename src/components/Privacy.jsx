    ...
    render() {
        return (
            <div>
                ...
                <p>
                    GregoryWilliams.me ({"us"}, {"we"}, or {"our"}) operates the
                    https://www.gregorywilliams.me website (hereinafter referred
                    to as the {"Service"}
                    ).
                </p>
                ...
                <p>
                    ...
                    that data. This Privacy Policy for GregoryWilliams.me is
                    powered by{" "}
                ...
                <p>
                    ...
                    Conditions, accessible from https://www.gregorywilliams.me
                </p>
                ...
                <p>
                    GregoryWilliams.me uses the collected data for various
                    purposes:
                </p>
                <ul>
                ...
                <p>
                    GregoryWilliams.me will take all steps reasonably necessary
                ...
                <p>
                    GregoryWilliams.me may disclose your Personal Data in the
                ...
                <ul>
                    <li>
                        ...
                        <p>
                            Facebook Analytics is a web analytics service
                            offered by Facebook that tracks and reports website
                            traffic. Facebook uses the data collected to track
                            and monitor the use of our Service. This data is
                            shared with other Facebook services. Facebook may
                            use the collected data to contextualize and
                            personalize the ads of its own advertising network.
                        </p>
                        <p>
                            For more information on the privacy practices of
                            Facebook, and for tools to opt-out of having your
                            activity on the Service available to Facebook
                            Analytics, please visit the Facebook Data Policy
                            page:{" "}
                ...
                <ul>
                    <li>By email: privacy@gregorywilliams.me</li>
                </ul>
            </div>
        );
    }
